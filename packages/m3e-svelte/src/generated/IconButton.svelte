...
<script lang="ts">
  ...
  let { disabled, disabledInteractive, download, href, name, rel, selected, shape, size, target, toggle, type, value, variant, width, children, selectedSnippet, oninput, onchange, onclick, element = $bindable(), ...rest }: Props = $props();
</script>
