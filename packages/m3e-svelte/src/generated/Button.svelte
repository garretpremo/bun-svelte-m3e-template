...
<script lang="ts">
  ...
  let { disabled, disabledInteractive, download, href, name, rel, selected, shape, size, target, toggle, type, value, variant, children, icon, selectedSnippet, selectedIcon, trailingIcon, oninput, onchange, onclick, element = $bindable() }: Props = $props();
</script>
