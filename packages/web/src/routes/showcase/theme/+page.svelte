...
// Containers grouped so the swatch grid stays compact.
...
<section>
  <h2>Theme</h2>
  <p class="body-large">
    Pick a seed color and scheme. Choices apply globally and persist across reloads
    (stored in <code>localStorage</code>). Surfaces and components below re-render
    immediately so you can see how each role responds.
  </p>
  ...
  <div class="surfaces accent">
    {#each ACCENT_CONTAINERS as token}
