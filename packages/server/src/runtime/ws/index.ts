...
export function wsOnOpen(ws: ServerWebSocket<undefined>): void { sockets.add(ws); }
export function wsOnClose(ws: ServerWebSocket<undefined>): void { sockets.delete(ws); }
